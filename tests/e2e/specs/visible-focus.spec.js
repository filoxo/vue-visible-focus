describe("VisibleFocus", () => {
  ...
  describe("hides focus ring when clicking", () => {
    ...
    it("on a div with tabindex", () => {
      cy.findByText(/focusable subheader/i)
        .should("exist")
        .click()
      cy.focused()
        .should("have.css", "outline")
    ...
    it("switching from keyboard to mouse modality", () => {
  ...
  describe("shows focus ring when", () => {
    it("clicking on an input element", () => {
      cy.findByPlaceholderText("An input")
        .should("exist")
        .click()
      cy.focused()
        .should("have.css", "outline")
    ...
    it("switching from mouse to keyboard modality", () => {
      cy.findByText(/focusable subheader/i).click()
      cy.get("body")
        .click(10, 10)
        .tab()
      // cy.findByText(/focusable subheader/i).focus()
